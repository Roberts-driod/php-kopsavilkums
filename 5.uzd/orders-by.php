...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['first_name'])) {
    ...
    if ($result->num_rows > 0) {
        // Iegūstam visus rezultātus kā masīvu
        ...
        // Izmantojam foreach, lai izvadītu pasūtījumus
